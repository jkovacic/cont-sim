% Solve a set of ordinary differential equations using an alternative 2nd order Heun method 
...
function output = integ_heun2_23(model, initial_condition, t_start, t_stop, t_step, outputf, param)
