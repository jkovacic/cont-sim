classdef Verner8 < IntegRkAb
    % A differential equation solver, based on the 8th order Verner's method.
    % The method is described at:
    % http://www.mymathlib.com/c_source/diffeq/runge_kutta/runge_kutta_verner.c
    
    methods
        function obj = Verner8(model, input, t_start, t_stop, t_step, init_condition)
            % Constructor.
            %
            % Input:
            ...
            obj.B = [9, 0, 0, 0, 0, 0, 0, 49, 64, 49, 9] / 180;
            obj.C = [ 0, 0.5, 0.5, (7+s21)/14, (7+s21)/14, 0.5, ...
